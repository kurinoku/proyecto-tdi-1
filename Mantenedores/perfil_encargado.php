        ...
        <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
            <div class="card p-1 bg-white">
                <div class=" image d-flex flex-column justify-content-center align-items-center">
                    ...
                    <p class="lead mt-3"><strong> <?php echo $nombre ?></strong> </p>
                    <p class="lead"><strong> <?php echo $rut ?> </strong></p>
                    <div class="text mt-3">
                        <p class="lead">Correo: <?php echo $correo ?></p>
                        <p class="lead">Numero: <?php echo $numero ?></p>
                        <p class="lead">Municipalidad: <?php echo $muni ?></p>
                        <p class="lead">Departamento: <?php echo $depa ?></p>
                    </div>
                    <a href=<?php echoRutaComillas("Mantenedores/editar_perfil_encargado.php"); ?> class="link">
