    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if (isset($_POST['usuario'])){
                ...
                $query = "SELECT * FROM ciudadano WHERE Rut_persona='$username' and Clave_persona='$password'";
                $result = mysqli_query($conexion,$query) or die(mysql_error());
                $rows = mysqli_num_rows($result);
                if($rows==1){
                    $_SESSION['usuario'] = $username;
                    header("Location: Mantenedores/index_persona.php"); // Redirect user to index.php
                }else{
                    echo "<div class='form'><h3>Usuario/Contraseña Incorrecto</h3><br/>Haz click aquí para <a href='login_persona.php'>Logearte</a></div>";
                }
            }else{
                ?>
                <form method="POST" action="" class="form-signin">
                    <h1 class="h3 mb-3 font-weight-normal">Identificación de ciudadano</h1>
                    <input id="usuarioInput" type="text" placeholder="Rut: XX XXX XX" name="usuario"  class="form-control" required autofocus>
